<?php
// source: phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/conf/config.neon
// source: phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/conf/config.level9.neon
// source: /data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/extension-installer/src/../../phpstan-doctrine/extension.neon
// source: /data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/extension-installer/src/../../phpstan-doctrine/rules.neon
// source: /data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/extension-installer/src/../../phpstan-symfony/extension.neon
// source: /data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/extension-installer/src/../../phpstan-symfony/rules.neon
// source: /data/www/salt-and-pepper.lan/dev/webroot/phpstan.neon
// source: array
...
class Container_0eb69a9442 extends _PHPStan_c875e8309\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.diagnoseExtension' => ['086' => true, '0476' => true, '0595' => true],
		'phpstan.broker.methodsClassReflectionExtension' => ['0107' => true, '0478' => true, '0479' => true],
		...
		'phpstan.dynamicMethodThrowTypeExtension' => ['0229' => true, '0230' => true, '0233' => true, '0544' => true],
		...
		'phpstan.properties.readWriteExtension' => ['0493' => true, '0541' => true, '0600' => true],
		'phpstan.broker.expressionTypeResolverExtension' => ['0495' => true],
		...
		'phpstan.phpDoc.typeNodeResolverExtension' => ['0542' => true, '0543' => true],
		'phpstan.forbiddenClassNamesExtension' => ['0545' => true, '0552' => true],
		'phpstan.additionalConstructorsExtension' => ['0600' => true],
	];
	...
	protected $wiring = [
		...
		'PHPStan\Rules\Constants\MissingClassConstantTypehintRule' => [['rules.164']],
		'PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule' => [['rules.165']],
		'PHPStan\Rules\Methods\MissingMethodReturnTypehintRule' => [['rules.166']],
		'PHPStan\Rules\Properties\MissingPropertyTypehintRule' => [['rules.167']],
		'PHPStan\Rules\Doctrine\ORM\DqlRule' => [['rules.168']],
		'PHPStan\Rules\Doctrine\ORM\RepositoryMethodCallRule' => [['rules.169']],
		'PHPStan\Rules\Doctrine\ORM\EntityNotFinalRule' => [['rules.170'], ['0549']],
		'PHPStan\Rules\Symfony\ContainerInterfacePrivateServiceRule' => [['rules.171']],
		'PHPStan\Rules\Symfony\ContainerInterfaceUnknownServiceRule' => [['rules.172']],
		'PHPStan\Rules\Symfony\UndefinedArgumentRule' => [['rules.173']],
		'PHPStan\Rules\Symfony\InvalidArgumentDefaultValueRule' => [['rules.174']],
		'PHPStan\Rules\Symfony\UndefinedOptionRule' => [['rules.175']],
		'PHPStan\Rules\Symfony\InvalidOptionDefaultValueRule' => [['rules.176']],
		...
		'PHPStan\PhpDoc\StubFilesExtension' => [['040', '041', '043', '044', '0496', '0593', '0594']],
		...
		'PHPStan\Diagnose\DiagnoseExtension' => [0 => ['086', '0476', '0595'], 2 => [1 => 'phpstanDiagnoseExtension']],
		...
		'PHPStan\Reflection\MethodsClassReflectionExtension' => [['091', '0101', '0103', '0105', '0107', '0478', '0479']],
		...
		'PHPStan\Type\DynamicMethodThrowTypeExtension' => [['0229', '0230', '0233', '0544']],
		...
		'PHPStan\Type\MethodTypeSpecifyingExtension' => [
			['0272', '0487', '0539', '0540', '0561', '0562', '0563', '0564', '0566', '0573', '0578', '0599'],
		],
		...
		'PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule' => [['0471']],
		'PHPStan\Rules\Methods\MissingMethodParameterTypehintRule' => [['0472']],
		'PHPStan\Rules\Methods\MissingMethodSelfOutTypeRule' => [['0473']],
		'PHPStan\Type\Doctrine\DescriptorRegistryFactory' => [['0474']],
		...
		'PHPStan\Doctrine\Driver\DriverDetector' => [['0475']],
		'PHPStan\Doctrine\DoctrineDiagnoseExtension' => [['0476']],
		'PHPStan\Type\Doctrine\HydrationModeReturnTypeResolver' => [['0477']],
		'PHPStan\Reflection\Doctrine\DoctrineSelectableClassReflectionExtension' => [['0478']],
		'PHPStan\Reflection\Doctrine\EntityRepositoryClassReflectionExtension' => [['0479']],
		'PHPStan\Type\Doctrine\QueryBuilder\CreateQueryBuilderDynamicReturnTypeExtension' => [['0480']],
		'PHPStan\Type\Doctrine\QueryBuilder\EntityRepositoryCreateQueryBuilderDynamicReturnTypeExtension' => [['0481']],
		'PHPStan\Type\Doctrine\DoctrineSelectableDynamicReturnTypeExtension' => [['0482']],
		'PHPStan\Type\Doctrine\ObjectMetadataResolver' => [['0483']],
		'PHPStan\Type\Doctrine\QueryBuilder\QueryBuilderGetDqlDynamicReturnTypeExtension' => [['0484']],
		'PHPStan\Type\Doctrine\QueryBuilder\QueryBuilderGetQueryDynamicReturnTypeExtension' => [['0485']],
		'PHPStan\Type\Doctrine\QueryBuilder\QueryBuilderMethodDynamicReturnTypeExtension' => [['0486']],
		'PHPStan\Type\Doctrine\QueryBuilder\QueryBuilderTypeSpecifyingExtension' => [['0487']],
		'PHPStan\Type\Doctrine\Query\QueryGetDqlDynamicReturnTypeExtension' => [['0488']],
		'PHPStan\Type\Doctrine\CreateQueryDynamicReturnTypeExtension' => [['0489']],
		'PHPStan\Type\Doctrine\Query\QueryResultDynamicReturnTypeExtension' => [['0490']],
		'PHPStan\Type\Doctrine\QueryBuilder\Expr\ExpressionBuilderDynamicReturnTypeExtension' => [['0491']],
		'PHPStan\Type\Doctrine\QueryBuilder\Expr\BaseExpressionDynamicReturnTypeExtension' => [['0492']],
		'PHPStan\Rules\Properties\ReadWritePropertiesExtension' => [['0493', '0541', '0600']],
		'PHPStan\Rules\Doctrine\ORM\PropertiesExtension' => [['0493']],
		'PHPStan\Type\Doctrine\QueryBuilder\OtherMethodQueryBuilderParser' => [['0494']],
		'PHPStan\Type\ExpressionTypeResolverExtension' => [['0495']],
		'PHPStan\Type\Doctrine\QueryBuilder\ReturnQueryBuilderExpressionTypeResolverExtension' => [['0495']],
		'PHPStan\Stubs\Doctrine\StubFilesExtensionLoader' => [['0496']],
		...
		'PHPStan\Type\Doctrine\QueryBuilder\Expr\NewExprDynamicReturnTypeExtension' => [
			['0497', '0498', '0499', '0500', '0501', '0502', '0503', '0504'],
		],
		'PHPStan\Type\Doctrine\DBAL\QueryBuilder\QueryBuilderExecuteMethodExtension' => [['0505']],
		'PHPStan\Type\Doctrine\DBAL\RowCountMethodDynamicReturnTypeExtension' => [['0506', '0507']],
		...
		'PHPStan\Type\Doctrine\Descriptors\ArrayType' => [['0508']],
		'PHPStan\Type\Doctrine\Descriptors\AsciiStringType' => [['0509']],
		'PHPStan\Type\Doctrine\Descriptors\BigIntType' => [['0510']],
		'PHPStan\Type\Doctrine\Descriptors\BinaryType' => [['0511']],
		'PHPStan\Type\Doctrine\Descriptors\BlobType' => [['0512']],
		'PHPStan\Type\Doctrine\Descriptors\DoctrineTypeDriverAwareDescriptor' => [['0513', '0521', '0522', '0534', '0535']],
		'PHPStan\Type\Doctrine\Descriptors\BooleanType' => [['0513']],
		'PHPStan\Type\Doctrine\Descriptors\DateImmutableType' => [['0514']],
		'PHPStan\Type\Doctrine\Descriptors\DateIntervalType' => [['0515']],
		'PHPStan\Type\Doctrine\Descriptors\DateTimeImmutableType' => [['0516']],
		'PHPStan\Type\Doctrine\Descriptors\DateTimeType' => [['0517']],
		'PHPStan\Type\Doctrine\Descriptors\DateTimeTzImmutableType' => [['0518']],
		'PHPStan\Type\Doctrine\Descriptors\DateTimeTzType' => [['0519']],
		'PHPStan\Type\Doctrine\Descriptors\DateType' => [['0520']],
		'PHPStan\Type\Doctrine\Descriptors\DecimalType' => [['0521']],
		'PHPStan\Type\Doctrine\Descriptors\FloatType' => [['0522']],
		'PHPStan\Type\Doctrine\Descriptors\GuidType' => [['0523']],
		'PHPStan\Type\Doctrine\Descriptors\IntegerType' => [['0524']],
		'PHPStan\Type\Doctrine\Descriptors\JsonArrayType' => [['0525']],
		'PHPStan\Type\Doctrine\Descriptors\JsonType' => [['0526']],
		'PHPStan\Type\Doctrine\Descriptors\ObjectType' => [['0527']],
		'PHPStan\Type\Doctrine\Descriptors\SimpleArrayType' => [['0528']],
		'PHPStan\Type\Doctrine\Descriptors\SmallIntType' => [['0529']],
		'PHPStan\Type\Doctrine\Descriptors\StringType' => [['0530']],
		'PHPStan\Type\Doctrine\Descriptors\TextType' => [['0531']],
		'PHPStan\Type\Doctrine\Descriptors\TimeImmutableType' => [['0532']],
		'PHPStan\Type\Doctrine\Descriptors\TimeType' => [['0533']],
		'PHPStan\Type\Doctrine\Descriptors\ReflectionDescriptor' => [['0534', '0535']],
		'PHPStan\Type\Doctrine\Descriptors\Ramsey\UuidTypeDescriptor' => [['0536', '0537', '0538']],
		'PHPStan\Type\Doctrine\Collection\IsEmptyTypeSpecifyingExtension' => [['0539', '0540']],
		'PHPStan\Rules\Gedmo\PropertiesExtension' => [['0541']],
		'PHPStan\PhpDoc\TypeNodeResolverExtension' => [['0542', '0543']],
		'PHPStan\PhpDoc\TypeNodeResolverAwareExtension' => [['0542']],
		'PHPStan\PhpDoc\Doctrine\QueryTypeNodeResolverExtension' => [['0542']],
		'PHPStan\PhpDoc\Doctrine\DoctrineLiteralStringTypeNodeResolverExtension' => [['0543']],
		'PHPStan\Type\Doctrine\EntityManagerInterfaceThrowTypeExtension' => [['0544']],
		'PHPStan\Classes\ForbiddenClassNameExtension' => [['0545', '0552']],
		'PHPStan\Classes\DoctrineProxyForbiddenClassNamesExtension' => [['0545', '0552']],
		'PHPStan\Rules\Doctrine\ORM\QueryBuilderDqlRule' => [['0546']],
		'PHPStan\Rules\Doctrine\ORM\EntityColumnRule' => [['0547']],
		'PHPStan\Rules\Doctrine\ORM\EntityMappingExceptionRule' => [['0548']],
		'PHPStan\Rules\Doctrine\ORM\EntityRelationRule' => [['0550']],
		'PHPStan\Rules\Doctrine\ORM\EntityConstructorNotFinalRule' => [['0551']],
		'PHPStan\Symfony\Configuration' => [['0553']],
		'PHPStan\Symfony\ConsoleApplicationResolver' => [['0554']],
		'PHPStan\Symfony\ServiceMapFactory' => [['symfony.serviceMapFactory']],
		'PHPStan\Symfony\ServiceMap' => [['0555']],
		'PHPStan\Symfony\ParameterMapFactory' => [['symfony.parameterMapFactory']],
		'PHPStan\Symfony\ParameterMap' => [['0556']],
		'PHPStan\Type\Symfony\ServiceDynamicReturnTypeExtension' => [['0557', '0558', '0559', '0560']],
		'PHPStan\Type\Symfony\ServiceTypeSpecifyingExtension' => [['0561', '0562', '0563', '0564']],
		'PHPStan\Type\Symfony\RequestDynamicReturnTypeExtension' => [['0565']],
		'PHPStan\Type\Symfony\RequestTypeSpecifyingExtension' => [['0566']],
		'PHPStan\Type\Symfony\InputBagDynamicReturnTypeExtension' => [['0567']],
		'PHPStan\Type\Symfony\HeaderBagDynamicReturnTypeExtension' => [['0568']],
		'PHPStan\Type\Symfony\SerializerDynamicReturnTypeExtension' => [['0569', '0570']],
		'PHPStan\Type\Symfony\EnvelopeReturnTypeExtension' => [['0571']],
		'PHPStan\Type\Symfony\InputInterfaceGetArgumentDynamicReturnTypeExtension' => [['0572']],
		'PHPStan\Type\Symfony\ArgumentTypeSpecifyingExtension' => [['0573']],
		'PHPStan\Type\Symfony\InputInterfaceHasArgumentDynamicReturnTypeExtension' => [['0574']],
		'PHPStan\Type\Symfony\GetOptionTypeHelper' => [['0575']],
		'PHPStan\Type\Symfony\InputInterfaceGetOptionDynamicReturnTypeExtension' => [['0576']],
		'PHPStan\Type\Symfony\InputInterfaceGetOptionsDynamicReturnTypeExtension' => [['0577']],
		'PHPStan\Type\Symfony\OptionTypeSpecifyingExtension' => [['0578']],
		'PHPStan\Type\Symfony\InputInterfaceHasOptionDynamicReturnTypeExtension' => [['0579']],
		'PHPStan\Type\Symfony\Config\ArrayNodeDefinitionPrototypeDynamicReturnTypeExtension' => [['0580']],
		'PHPStan\Type\Symfony\Config\ReturnParentDynamicReturnTypeExtension' => [['0581', '0583', '0585']],
		'PHPStan\Type\Symfony\Config\PassParentObjectDynamicReturnTypeExtension' => [['0582', '0584']],
		'PHPStan\Type\Symfony\Config\TreeBuilderDynamicReturnTypeExtension' => [['0586']],
		'PHPStan\Type\Symfony\Config\TreeBuilderGetRootNodeDynamicReturnTypeExtension' => [['0587']],
		'PHPStan\Type\Symfony\KernelInterfaceDynamicReturnTypeExtension' => [['0588']],
		'PHPStan\Type\Symfony\ParameterDynamicReturnTypeExtension' => [['0589', '0590', '0591', '0592']],
		'PHPStan\Symfony\InputBagStubFilesExtension' => [['0593']],
		'PHPStan\Symfony\PasswordAuthenticatedUserStubFilesExtension' => [['0594']],
		'PHPStan\Symfony\SymfonyDiagnoseExtension' => [['0595']],
		'PHPStan\Type\Symfony\Form\FormInterfaceDynamicReturnTypeExtension' => [['0596']],
		'PHPStan\Type\Symfony\CommandGetHelperDynamicReturnTypeExtension' => [['0597']],
		'PHPStan\Type\Symfony\ResponseHeaderBagDynamicReturnTypeExtension' => [['0598']],
		'PHPStan\Type\Symfony\InputBagTypeSpecifyingExtension' => [['0599']],
		'PHPStan\Reflection\AdditionalConstructorsExtension' => [['0600']],
		'PHPStan\Symfony\RequiredAutowiringExtension' => [['0600']],
		'PHPStan\Type\Symfony\CacheInterfaceGetDynamicReturnTypeExtension' => [['0601']],
		'PHPStan\Type\Symfony\ExtensionGetConfigurationReturnTypeExtension' => [['0602']],
	];
	...
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(null, ['/data/www/salt-and-pepper.lan/dev/webroot']);
	}
	...
	public function createService042(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			$this->getService('070'),
			[
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionAttribute.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClass.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClassConstant.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionFunctionAbstract.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionMethod.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionParameter.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionProperty.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/iterable.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/ArrayObject.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/WeakReference.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/ext-ds.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/ImagickPixel.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/PDOStatement.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/date.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/ibm_db2.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/mysqli.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/zip.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/dom.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/spl.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/SplObjectStorage.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/Exception.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/arrayFunctions.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/core.stub',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/typeCheckingFunctions.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/Criteria.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/DBAL/Cache/CacheException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/DBAL/Cache/QueryCacheProfile.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/DBAL/Exception/UniqueConstraintViolationException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/DBAL/Types/Type.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/DBAL/Exception.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/DBAL/Result.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/DocumentManager.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/DocumentRepository.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/EntityManager.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/EntityManagerDecorator.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/EntityManagerInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/EntityRepository.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/MongoClassMetadataInfo.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/Persistence/ManagerRegistry.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/Persistence/ObjectManager.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/Persistence/ObjectManagerDecorator.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/Persistence/ObjectRepository.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/RepositoryFactory.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/Collections/ArrayCollection.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/Collections/Selectable.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/AbstractQuery.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Exception/ORMException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Id/AbstractIdGenerator.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Mapping/ClassMetadata.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Mapping/ClassMetadataInfo.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Mapping/ManyToManyInverseSideMapping.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Mapping/ManyToManyOwningSideMapping.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Mapping/ManyToOneAssociationMapping.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Mapping/OneToManyAssociationMapping.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Mapping/OneToOneInverseSideMapping.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Mapping/OneToOneOwningSideMapping.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/NonUniqueResultException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/NoResultException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/ORMException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/UnexpectedResultException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Query/Expr.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Query.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/QueryBuilder.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Query/Expr/Comparison.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Query/Expr/Composite.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Query/Expr/Func.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Query/Expr/Join.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ORM/Tools/Pagination/Paginator.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/Persistence/Mapping/ClassMetadata.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/stubs/ServiceDocumentRepository.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Psr/Cache/CacheException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Psr/Cache/CacheItemInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Psr/Cache/InvalidArgumentException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Bundle/FrameworkBundle/Controller/AbstractController.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Bundle/FrameworkBundle/KernelBrowser.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Bundle/FrameworkBundle/Test/KernelTestCase.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Bundle/FrameworkBundle/Test/TestContainer.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Bundle/SecurityBundle/DependencyInjection/Security/Factory/AuthenticatorFactoryInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Bundle/SecurityBundle/DependencyInjection/Security/Factory/FirewallListenerFactoryInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Console/Command.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Console/Exception/ExceptionInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Console/Exception/InvalidArgumentException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Console/Exception/LogicException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Console/Helper/HelperInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Console/Output/OutputInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/DependencyInjection/ContainerBuilder.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/DependencyInjection/Extension/ExtensionInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/EventDispatcher/EventDispatcherInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/EventDispatcher/EventSubscriberInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/EventDispatcher/GenericEvent.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/AbstractType.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/ChoiceList/Loader/ChoiceLoaderInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/Exception/ExceptionInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/Exception/RuntimeException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/Exception/TransformationFailedException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/DataTransformerInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/FormBuilderInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/FormConfigBuilderInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/FormConfigInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/FormInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/FormFactoryInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/FormTypeExtensionInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/FormTypeInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Form/FormView.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/HttpFoundation/Cookie.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/HttpFoundation/HeaderBag.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/HttpFoundation/ParameterBag.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/HttpFoundation/Session.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Messenger/StampInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Messenger/Envelope.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/OptionsResolver/Exception/InvalidOptionsException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/OptionsResolver/Options.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Process/Exception/LogicException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Process/Process.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/PropertyAccess/Exception/AccessException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/PropertyAccess/Exception/ExceptionInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/PropertyAccess/Exception/InvalidArgumentException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/PropertyAccess/Exception/RuntimeException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/PropertyAccess/Exception/UnexpectedTypeException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/PropertyAccess/PropertyAccessorInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/PropertyAccess/PropertyPathInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Security/Acl/Model/AclInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Security/Acl/Model/EntryInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Security/Core/Authentication/Token/TokenInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Security/Core/Authorization/Voter/Voter.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Security/Core/Authorization/Voter/VoterInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Encoder/ContextAwareDecoderInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Encoder/DecoderInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Encoder/EncoderInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Exception/BadMethodCallException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Exception/CircularReferenceException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Exception/ExceptionInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Exception/ExtraAttributesException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Exception/InvalidArgumentException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Exception/LogicException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Exception/RuntimeException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Exception/UnexpectedValueException.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Normalizer/ContextAwareDenormalizerInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Normalizer/ContextAwareNormalizerInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Normalizer/DenormalizableInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Normalizer/DenormalizerInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Normalizer/NormalizableInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Serializer/Normalizer/NormalizerInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Validator/Constraint.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Validator/Constraints/Composite.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Validator/Constraints/Compound.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Validator/ConstraintViolationInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Component/Validator/ConstraintViolationListInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Contracts/Cache/CacheInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Contracts/Cache/CallbackInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Contracts/Cache/ItemInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Symfony/Contracts/Service/ServiceSubscriberInterface.stub',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/stubs/Twig/Node/Node.stub',
			],
			['/data/www/salt-and-pepper.lan/dev/webroot']
		);
	}
	...
	public function createService057(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_0eb69a9442 $container)
			{
			...
			public function create(): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/../../../tmp/phpstan/resultCache.php',
					$this->container->getParameter('analysedPaths'),
					['/data/www/salt-and-pepper.lan/dev/webroot'],
					'9',
					null,
					[
						'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
						'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionAttribute.php',
						'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/Attribute.php',
						'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionIntersectionType.php',
					],
					[],
					[],
					false
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/../../../tmp/phpstan/resultCache.php');
	}
	...
	public function createService065(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			['/data/www/salt-and-pepper.lan/dev/webroot'],
			[
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/conf/parametersSchema.neon',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/conf/config.level9.neon',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/conf/config.level7.neon',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/conf/config.level4.neon',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/conf/config.level3.neon',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/conf/config.level2.neon',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/conf/config.level1.neon',
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/conf/config.level0.neon',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/extension.neon',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-doctrine/rules.neon',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/extension.neon',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan-symfony/rules.neon',
				'/data/www/salt-and-pepper.lan/dev/webroot/phpstan.neon',
			],
			null,
			[
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
	...
	public function createService072(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/data/www/salt-and-pepper.lan/dev/webroot',
			'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/../../../tmp/phpstan',
			[
				'phar:///data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/phpstan.phar/conf/config.level9.neon',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/extension-installer/src/../../phpstan-doctrine/extension.neon',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/extension-installer/src/../../phpstan-doctrine/rules.neon',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/extension-installer/src/../../phpstan-symfony/extension.neon',
				'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/extension-installer/src/../../phpstan-symfony/rules.neon',
				'/data/www/salt-and-pepper.lan/dev/webroot/phpstan.neon',
			],
			$this->getParameter('analysedPaths'),
			['/data/www/salt-and-pepper.lan/dev/webroot'],
	...
	{
		return new PHPStan\File\FileHelper('/data/www/salt-and-pepper.lan/dev/webroot');
	}
	...
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchCheck($this->getService('0167'), true, false, false, false);
	}
	...
	{
		return new PHPStan\Rules\Keywords\RequireFileExistsRule('/data/www/salt-and-pepper.lan/dev/webroot');
	}
	...
	{
		return new PHPStan\Rules\Functions\CallCallablesRule($this->getService('0138'), $this->getService('0167'), true);
	}
	...
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule($this->getService('0167'), true);
	}
	...
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule($this->getService('0167'), $this->getService('0121'), true);
	}
	...
	{
		return new PHPStan\Rules\Generators\YieldFromTypeRule($this->getService('0167'), true);
	}
	...
	public function createService0471(): PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule($this->getService('0153'), false);
	}


	public function createService0472(): PHPStan\Rules\Methods\MissingMethodParameterTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodParameterTypehintRule($this->getService('0153'), false);
	}


	public function createService0473(): PHPStan\Rules\Methods\MissingMethodSelfOutTypeRule
	{
		return new PHPStan\Rules\Methods\MissingMethodSelfOutTypeRule($this->getService('0153'));
	}


	public function createService0474(): PHPStan\Type\Doctrine\DescriptorRegistryFactory
	{
		return new PHPStan\Type\Doctrine\DescriptorRegistryFactory($this->getService('070'));
	}


	public function createService0475(): PHPStan\Doctrine\Driver\DriverDetector
	{
		return new PHPStan\Doctrine\Driver\DriverDetector;
	}


	public function createService0476(): PHPStan\Doctrine\DoctrineDiagnoseExtension
	{
		return new PHPStan\Doctrine\DoctrineDiagnoseExtension($this->getService('0483'), $this->getService('0475'));
	}


	public function createService0477(): PHPStan\Type\Doctrine\HydrationModeReturnTypeResolver
	{
		return new PHPStan\Type\Doctrine\HydrationModeReturnTypeResolver;
	}


	public function createService0478(): PHPStan\Reflection\Doctrine\DoctrineSelectableClassReflectionExtension
	{
		return new PHPStan\Reflection\Doctrine\DoctrineSelectableClassReflectionExtension($this->getService('reflectionProvider'));
	}


	public function createService0479(): PHPStan\Reflection\Doctrine\EntityRepositoryClassReflectionExtension
	{
		return new PHPStan\Reflection\Doctrine\EntityRepositoryClassReflectionExtension($this->getService('0483'));
	}


	public function createService0480(): PHPStan\Type\Doctrine\QueryBuilder\CreateQueryBuilderDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Doctrine\QueryBuilder\CreateQueryBuilderDynamicReturnTypeExtension(null, false);
	}


	public function createService0481(): PHPStan\Type\Doctrine\QueryBuilder\EntityRepositoryCreateQueryBuilderDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Doctrine\QueryBuilder\EntityRepositoryCreateQueryBuilderDynamicReturnTypeExtension;
	}


	public function createService0482(): PHPStan\Type\Doctrine\DoctrineSelectableDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Doctrine\DoctrineSelectableDynamicReturnTypeExtension;
	}


	public function createService0483(): PHPStan\Type\Doctrine\ObjectMetadataResolver
	{
		return new PHPStan\Type\Doctrine\ObjectMetadataResolver(
			'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/../../../tests/phpstan/object_manager.php',
			'/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/../../../tmp/phpstan'
		);
	}


	public function createService0484(): PHPStan\Type\Doctrine\QueryBuilder\QueryBuilderGetDqlDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Doctrine\QueryBuilder\QueryBuilderGetDqlDynamicReturnTypeExtension(null);
	}


	public function createService0485(): PHPStan\Type\Doctrine\QueryBuilder\QueryBuilderGetQueryDynamicReturnTypeExtension
	{
	...
	public function createService0486(): PHPStan\Type\Doctrine\QueryBuilder\QueryBuilderMethodDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Doctrine\QueryBuilder\QueryBuilderMethodDynamicReturnTypeExtension(null);
	}


	public function createService0487(): PHPStan\Type\Doctrine\QueryBuilder\QueryBuilderTypeSpecifyingExtension
	{
		return new PHPStan\Type\Doctrine\QueryBuilder\QueryBuilderTypeSpecifyingExtension(null);
	}


	public function createService0488(): PHPStan\Type\Doctrine\Query\QueryGetDqlDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Doctrine\Query\QueryGetDqlDynamicReturnTypeExtension;
	}


	public function createService0489(): PHPStan\Type\Doctrine\CreateQueryDynamicReturnTypeExtension
	{
	...
	public function createService0490(): PHPStan\Type\Doctrine\Query\QueryResultDynamicReturnTypeExtension
	{
	...
	public function createService0491(): PHPStan\Type\Doctrine\QueryBuilder\Expr\ExpressionBuilderDynamicReturnTypeExtension
	{
	...
	public function createService0492(): PHPStan\Type\Doctrine\QueryBuilder\Expr\BaseExpressionDynamicReturnTypeExtension
	{
	...
	public function createService0493(): PHPStan\Rules\Doctrine\ORM\PropertiesExtension
	{
		return new PHPStan\Rules\Doctrine\ORM\PropertiesExtension($this->getService('0483'));
	}


	public function createService0494(): PHPStan\Type\Doctrine\QueryBuilder\OtherMethodQueryBuilderParser
	{
	...
	public function createService0495(): PHPStan\Type\Doctrine\QueryBuilder\ReturnQueryBuilderExpressionTypeResolverExtension
	{
		return new PHPStan\Type\Doctrine\QueryBuilder\ReturnQueryBuilderExpressionTypeResolverExtension($this->getService('0494'));
	}


	public function createService0496(): PHPStan\Stubs\Doctrine\StubFilesExtensionLoader
	{
		return new PHPStan\Stubs\Doctrine\StubFilesExtensionLoader($this->getService('originalBetterReflectionReflector'));
	}


	public function createService0497(): PHPStan\Type\Doctrine\QueryBuilder\Expr\NewExprDynamicReturnTypeExtension
	{
	...
	public function createService0498(): PHPStan\Type\Doctrine\QueryBuilder\Expr\NewExprDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Doctrine\QueryBuilder\Expr\NewExprDynamicReturnTypeExtension(
			$this->getService('doctrineQueryBuilderArgumentsProcessor'),
	...
	public function createService0499(): PHPStan\Type\Doctrine\QueryBuilder\Expr\NewExprDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Doctrine\QueryBuilder\Expr\NewExprDynamicReturnTypeExtension(
			$this->getService('doctrineQueryBuilderArgumentsProcessor'),
	...
	public function createService0500(): PHPStan\Type\Doctrine\QueryBuilder\Expr\NewExprDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Doctrine\QueryBuilder\Expr\NewExprDynamicReturnTypeExtension(
			$this->getService('doctrineQueryBuilderArgumentsProcessor'),
	...
	public function createService0501(): PHPStan\Type\Doctrine\QueryBuilder\Expr\NewExprDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Doctrine\QueryBuilder\Expr\NewExprDynamicReturnTypeExtension(
			$this->getService('doctrineQueryBuilderArgumentsProcessor'),
	...
	public function createService0502(): PHPStan\Type\Doctrine\QueryBuilder\Expr\NewExprDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Doctrine\QueryBuilder\Expr\NewExprDynamicReturnTypeExtension(
			$this->getService('doctrineQueryBuilderArgumentsProcessor'),
	...
	public function createService0503(): PHPStan\Type\Doctrine\QueryBuilder\Expr\NewExprDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Doctrine\QueryBuilder\Expr\NewExprDynamicReturnTypeExtension(
			$this->getService('doctrineQueryBuilderArgumentsProcessor'),
	...
	public function createService0504(): PHPStan\Type\Doctrine\QueryBuilder\Expr\NewExprDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Doctrine\QueryBuilder\Expr\NewExprDynamicReturnTypeExtension(
			$this->getService('doctrineQueryBuilderArgumentsProcessor'),
	...
	public function createService0505(): PHPStan\Type\Doctrine\DBAL\QueryBuilder\QueryBuilderExecuteMethodExtension
	{
		return new PHPStan\Type\Doctrine\DBAL\QueryBuilder\QueryBuilderExecuteMethodExtension($this->getService('reflectionProvider'));
	}


	public function createService0506(): PHPStan\Type\Doctrine\DBAL\RowCountMethodDynamicReturnTypeExtension
	{
	...
	public function createService0507(): PHPStan\Type\Doctrine\DBAL\RowCountMethodDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Doctrine\DBAL\RowCountMethodDynamicReturnTypeExtension(
	...
	public function createService0508(): PHPStan\Type\Doctrine\Descriptors\ArrayType
	{
		return new PHPStan\Type\Doctrine\Descriptors\ArrayType;
	}


	public function createService0509(): PHPStan\Type\Doctrine\Descriptors\AsciiStringType
	{
		return new PHPStan\Type\Doctrine\Descriptors\AsciiStringType;
	}


	public function createService0510(): PHPStan\Type\Doctrine\Descriptors\BigIntType
	{
		return new PHPStan\Type\Doctrine\Descriptors\BigIntType;
	}


	public function createService0511(): PHPStan\Type\Doctrine\Descriptors\BinaryType
	{
		return new PHPStan\Type\Doctrine\Descriptors\BinaryType;
	}


	public function createService0512(): PHPStan\Type\Doctrine\Descriptors\BlobType
	{
		return new PHPStan\Type\Doctrine\Descriptors\BlobType;
	}


	public function createService0513(): PHPStan\Type\Doctrine\Descriptors\BooleanType
	{
		return new PHPStan\Type\Doctrine\Descriptors\BooleanType($this->getService('0475'));
	}


	public function createService0514(): PHPStan\Type\Doctrine\Descriptors\DateImmutableType
	{
		return new PHPStan\Type\Doctrine\Descriptors\DateImmutableType;
	}


	public function createService0515(): PHPStan\Type\Doctrine\Descriptors\DateIntervalType
	{
		return new PHPStan\Type\Doctrine\Descriptors\DateIntervalType;
	}


	public function createService0516(): PHPStan\Type\Doctrine\Descriptors\DateTimeImmutableType
	{
		return new PHPStan\Type\Doctrine\Descriptors\DateTimeImmutableType;
	}


	public function createService0517(): PHPStan\Type\Doctrine\Descriptors\DateTimeType
	{
		return new PHPStan\Type\Doctrine\Descriptors\DateTimeType;
	}


	public function createService0518(): PHPStan\Type\Doctrine\Descriptors\DateTimeTzImmutableType
	{
		return new PHPStan\Type\Doctrine\Descriptors\DateTimeTzImmutableType;
	}


	public function createService0519(): PHPStan\Type\Doctrine\Descriptors\DateTimeTzType
	{
		return new PHPStan\Type\Doctrine\Descriptors\DateTimeTzType;
	}


	public function createService0520(): PHPStan\Type\Doctrine\Descriptors\DateType
	{
		return new PHPStan\Type\Doctrine\Descriptors\DateType;
	}


	public function createService0521(): PHPStan\Type\Doctrine\Descriptors\DecimalType
	{
		return new PHPStan\Type\Doctrine\Descriptors\DecimalType($this->getService('0475'));
	}


	public function createService0522(): PHPStan\Type\Doctrine\Descriptors\FloatType
	{
		return new PHPStan\Type\Doctrine\Descriptors\FloatType($this->getService('0475'));
	}


	public function createService0523(): PHPStan\Type\Doctrine\Descriptors\GuidType
	{
		return new PHPStan\Type\Doctrine\Descriptors\GuidType;
	}


	public function createService0524(): PHPStan\Type\Doctrine\Descriptors\IntegerType
	{
		return new PHPStan\Type\Doctrine\Descriptors\IntegerType;
	}


	public function createService0525(): PHPStan\Type\Doctrine\Descriptors\JsonArrayType
	{
		return new PHPStan\Type\Doctrine\Descriptors\JsonArrayType;
	}


	public function createService0526(): PHPStan\Type\Doctrine\Descriptors\JsonType
	{
		return new PHPStan\Type\Doctrine\Descriptors\JsonType;
	}


	public function createService0527(): PHPStan\Type\Doctrine\Descriptors\ObjectType
	{
		return new PHPStan\Type\Doctrine\Descriptors\ObjectType;
	}


	public function createService0528(): PHPStan\Type\Doctrine\Descriptors\SimpleArrayType
	{
		return new PHPStan\Type\Doctrine\Descriptors\SimpleArrayType;
	}


	public function createService0529(): PHPStan\Type\Doctrine\Descriptors\SmallIntType
	{
		return new PHPStan\Type\Doctrine\Descriptors\SmallIntType;
	}


	public function createService0530(): PHPStan\Type\Doctrine\Descriptors\StringType
	{
		return new PHPStan\Type\Doctrine\Descriptors\StringType;
	}


	public function createService0531(): PHPStan\Type\Doctrine\Descriptors\TextType
	{
		return new PHPStan\Type\Doctrine\Descriptors\TextType;
	}


	public function createService0532(): PHPStan\Type\Doctrine\Descriptors\TimeImmutableType
	{
		return new PHPStan\Type\Doctrine\Descriptors\TimeImmutableType;
	}


	public function createService0533(): PHPStan\Type\Doctrine\Descriptors\TimeType
	{
		return new PHPStan\Type\Doctrine\Descriptors\TimeType;
	}


	public function createService0534(): PHPStan\Type\Doctrine\Descriptors\ReflectionDescriptor
	{
	...
	public function createService0535(): PHPStan\Type\Doctrine\Descriptors\ReflectionDescriptor
	{
		return new PHPStan\Type\Doctrine\Descriptors\ReflectionDescriptor(
	...
	public function createService0536(): PHPStan\Type\Doctrine\Descriptors\Ramsey\UuidTypeDescriptor
	{
		return new PHPStan\Type\Doctrine\Descriptors\Ramsey\UuidTypeDescriptor('Ramsey\Uuid\Doctrine\UuidType');
	}


	public function createService0537(): PHPStan\Type\Doctrine\Descriptors\Ramsey\UuidTypeDescriptor
	{
		return new PHPStan\Type\Doctrine\Descriptors\Ramsey\UuidTypeDescriptor('Ramsey\Uuid\Doctrine\UuidBinaryType');
	}


	public function createService0538(): PHPStan\Type\Doctrine\Descriptors\Ramsey\UuidTypeDescriptor
	{
		return new PHPStan\Type\Doctrine\Descriptors\Ramsey\UuidTypeDescriptor('Ramsey\Uuid\Doctrine\UuidBinaryOrderedTimeType');
	}


	public function createService0539(): PHPStan\Type\Doctrine\Collection\IsEmptyTypeSpecifyingExtension
	{
		return new PHPStan\Type\Doctrine\Collection\IsEmptyTypeSpecifyingExtension('Doctrine\Common\Collections\Collection');
	}


	public function createService0540(): PHPStan\Type\Doctrine\Collection\IsEmptyTypeSpecifyingExtension
	{
	...
	public function createService0541(): PHPStan\Rules\Gedmo\PropertiesExtension
	{
		return new PHPStan\Rules\Gedmo\PropertiesExtension($this->getService('0483'));
	}


	public function createService0542(): PHPStan\PhpDoc\Doctrine\QueryTypeNodeResolverExtension
	{
		return new PHPStan\PhpDoc\Doctrine\QueryTypeNodeResolverExtension;
	}


	public function createService0543(): PHPStan\PhpDoc\Doctrine\DoctrineLiteralStringTypeNodeResolverExtension
	{
		return new PHPStan\PhpDoc\Doctrine\DoctrineLiteralStringTypeNodeResolverExtension(false);
	}


	public function createService0544(): PHPStan\Type\Doctrine\EntityManagerInterfaceThrowTypeExtension
	{
		return new PHPStan\Type\Doctrine\EntityManagerInterfaceThrowTypeExtension;
	}


	public function createService0545(): PHPStan\Classes\DoctrineProxyForbiddenClassNamesExtension
	{
		return new PHPStan\Classes\DoctrineProxyForbiddenClassNamesExtension($this->getService('0483'));
	}


	public function createService0546(): PHPStan\Rules\Doctrine\ORM\QueryBuilderDqlRule
	{
		return new PHPStan\Rules\Doctrine\ORM\QueryBuilderDqlRule($this->getService('0483'), false);
	}


	public function createService0547(): PHPStan\Rules\Doctrine\ORM\EntityColumnRule
	{
	...
	public function createService0548(): PHPStan\Rules\Doctrine\ORM\EntityMappingExceptionRule
	{
		return new PHPStan\Rules\Doctrine\ORM\EntityMappingExceptionRule($this->getService('0483'));
	}


	public function createService0549(): PHPStan\Rules\Doctrine\ORM\EntityNotFinalRule
	{
		return new PHPStan\Rules\Doctrine\ORM\EntityNotFinalRule($this->getService('0483'));
	}


	public function createService0550(): PHPStan\Rules\Doctrine\ORM\EntityRelationRule
	{
		return new PHPStan\Rules\Doctrine\ORM\EntityRelationRule($this->getService('0483'), false, false);
	}


	public function createService0551(): PHPStan\Rules\Doctrine\ORM\EntityConstructorNotFinalRule
	{
		return new PHPStan\Rules\Doctrine\ORM\EntityConstructorNotFinalRule($this->getService('0483'));
	}


	public function createService0552(): PHPStan\Classes\DoctrineProxyForbiddenClassNamesExtension
	{
		return new PHPStan\Classes\DoctrineProxyForbiddenClassNamesExtension($this->getService('0483'));
	}


	public function createService0553(): PHPStan\Symfony\Configuration
	{
		return new PHPStan\Symfony\Configuration([
			'container_xml_path' => null,
			'containerXmlPath' => '/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/../../../var/cache/dev/App_KernelDevDebugContainer.xml',
			'constant_hassers' => true,
			'constantHassers' => true,
			'console_application_loader' => null,
			'consoleApplicationLoader' => '/data/www/salt-and-pepper.lan/dev/webroot/tests/phpstan/console_application.php',
		]);
	}


	public function createService0554(): PHPStan\Symfony\ConsoleApplicationResolver
	{
		return new PHPStan\Symfony\ConsoleApplicationResolver($this->getService('0553'));
	}


	public function createService0555(): PHPStan\Symfony\ServiceMap
	{
		return $this->getService('symfony.serviceMapFactory')->create();
	}


	public function createService0556(): PHPStan\Symfony\ParameterMap
	{
		return $this->getService('symfony.parameterMapFactory')->create();
	}


	public function createService0557(): PHPStan\Type\Symfony\ServiceDynamicReturnTypeExtension
	{
	...
	public function createService0558(): PHPStan\Type\Symfony\ServiceDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\ServiceDynamicReturnTypeExtension(
	...
	public function createService0559(): PHPStan\Type\Symfony\ServiceDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\ServiceDynamicReturnTypeExtension(
	...
	public function createService0560(): PHPStan\Type\Symfony\ServiceDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\ServiceDynamicReturnTypeExtension(
	...
	public function createService0561(): PHPStan\Type\Symfony\ServiceTypeSpecifyingExtension
	{
	...
	public function createService0562(): PHPStan\Type\Symfony\ServiceTypeSpecifyingExtension
	{
		return new PHPStan\Type\Symfony\ServiceTypeSpecifyingExtension('Psr\Container\ContainerInterface', $this->getService('021'));
	}


	public function createService0563(): PHPStan\Type\Symfony\ServiceTypeSpecifyingExtension
	{
		return new PHPStan\Type\Symfony\ServiceTypeSpecifyingExtension(
			'Symfony\Bundle\FrameworkBundle\Controller\Controller',
			$this->getService('021')
	...
	public function createService0564(): PHPStan\Type\Symfony\ServiceTypeSpecifyingExtension
	{
		return new PHPStan\Type\Symfony\ServiceTypeSpecifyingExtension(
			'Symfony\Bundle\FrameworkBundle\Controller\AbstractController',
			$this->getService('021')
	...
	public function createService0565(): PHPStan\Type\Symfony\RequestDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\RequestDynamicReturnTypeExtension;
	}


	public function createService0566(): PHPStan\Type\Symfony\RequestTypeSpecifyingExtension
	{
		return new PHPStan\Type\Symfony\RequestTypeSpecifyingExtension;
	}


	public function createService0567(): PHPStan\Type\Symfony\InputBagDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\InputBagDynamicReturnTypeExtension;
	}


	public function createService0568(): PHPStan\Type\Symfony\HeaderBagDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\HeaderBagDynamicReturnTypeExtension;
	}


	public function createService0569(): PHPStan\Type\Symfony\SerializerDynamicReturnTypeExtension
	{
	...
	public function createService0570(): PHPStan\Type\Symfony\SerializerDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\SerializerDynamicReturnTypeExtension(
	...
	public function createService0571(): PHPStan\Type\Symfony\EnvelopeReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\EnvelopeReturnTypeExtension;
	}


	public function createService0572(): PHPStan\Type\Symfony\InputInterfaceGetArgumentDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\InputInterfaceGetArgumentDynamicReturnTypeExtension($this->getService('0554'));
	}


	public function createService0573(): PHPStan\Type\Symfony\ArgumentTypeSpecifyingExtension
	{
		return new PHPStan\Type\Symfony\ArgumentTypeSpecifyingExtension($this->getService('021'));
	}


	public function createService0574(): PHPStan\Type\Symfony\InputInterfaceHasArgumentDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\InputInterfaceHasArgumentDynamicReturnTypeExtension($this->getService('0554'));
	}


	public function createService0575(): PHPStan\Type\Symfony\GetOptionTypeHelper
	{
		return new PHPStan\Type\Symfony\GetOptionTypeHelper;
	}


	public function createService0576(): PHPStan\Type\Symfony\InputInterfaceGetOptionDynamicReturnTypeExtension
	{
	...
	public function createService0577(): PHPStan\Type\Symfony\InputInterfaceGetOptionsDynamicReturnTypeExtension
	{
	...
	public function createService0578(): PHPStan\Type\Symfony\OptionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Symfony\OptionTypeSpecifyingExtension($this->getService('021'));
	}


	public function createService0579(): PHPStan\Type\Symfony\InputInterfaceHasOptionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\InputInterfaceHasOptionDynamicReturnTypeExtension($this->getService('0554'));
	}


	public function createService0580(): PHPStan\Type\Symfony\Config\ArrayNodeDefinitionPrototypeDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\Config\ArrayNodeDefinitionPrototypeDynamicReturnTypeExtension;
	}


	public function createService0581(): PHPStan\Type\Symfony\Config\ReturnParentDynamicReturnTypeExtension
	{
	...
	public function createService0582(): PHPStan\Type\Symfony\Config\PassParentObjectDynamicReturnTypeExtension
	{
	...
	public function createService0583(): PHPStan\Type\Symfony\Config\ReturnParentDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\Config\ReturnParentDynamicReturnTypeExtension(
			'Symfony\Component\Config\Definition\Builder\NodeBuilder',
			['end']
	...
	public function createService0584(): PHPStan\Type\Symfony\Config\PassParentObjectDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\Config\PassParentObjectDynamicReturnTypeExtension(
	...
	public function createService0585(): PHPStan\Type\Symfony\Config\ReturnParentDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\Config\ReturnParentDynamicReturnTypeExtension(
			'Symfony\Component\Config\Definition\Builder\NodeDefinition',
			['end']
	...
	public function createService0586(): PHPStan\Type\Symfony\Config\TreeBuilderDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\Config\TreeBuilderDynamicReturnTypeExtension;
	}


	public function createService0587(): PHPStan\Type\Symfony\Config\TreeBuilderGetRootNodeDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\Config\TreeBuilderGetRootNodeDynamicReturnTypeExtension;
	}


	public function createService0588(): PHPStan\Type\Symfony\KernelInterfaceDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\KernelInterfaceDynamicReturnTypeExtension;
	}


	public function createService0589(): PHPStan\Type\Symfony\ParameterDynamicReturnTypeExtension
	{
	...
	public function createService0590(): PHPStan\Type\Symfony\ParameterDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\ParameterDynamicReturnTypeExtension(
			'Symfony\Component\DependencyInjection\ContainerInterface',
			'getParameter',
	...
	public function createService0591(): PHPStan\Type\Symfony\ParameterDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\ParameterDynamicReturnTypeExtension(
			'Symfony\Bundle\FrameworkBundle\Controller\AbstractController',
			'getParameter',
	...
	public function createService0592(): PHPStan\Type\Symfony\ParameterDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\ParameterDynamicReturnTypeExtension(
			'Symfony\Bundle\FrameworkBundle\Controller\Controller',
			'getParameter',
	...
	public function createService0593(): PHPStan\Symfony\InputBagStubFilesExtension
	{
		return new PHPStan\Symfony\InputBagStubFilesExtension($this->getService('originalBetterReflectionReflector'));
	}


	public function createService0594(): PHPStan\Symfony\PasswordAuthenticatedUserStubFilesExtension
	{
		return new PHPStan\Symfony\PasswordAuthenticatedUserStubFilesExtension($this->getService('originalBetterReflectionReflector'));
	}


	public function createService0595(): PHPStan\Symfony\SymfonyDiagnoseExtension
	{
		return new PHPStan\Symfony\SymfonyDiagnoseExtension($this->getService('0554'));
	}


	public function createService0596(): PHPStan\Type\Symfony\Form\FormInterfaceDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\Form\FormInterfaceDynamicReturnTypeExtension;
	}


	public function createService0597(): PHPStan\Type\Symfony\CommandGetHelperDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\CommandGetHelperDynamicReturnTypeExtension($this->getService('0554'));
	}


	public function createService0598(): PHPStan\Type\Symfony\ResponseHeaderBagDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\ResponseHeaderBagDynamicReturnTypeExtension;
	}


	public function createService0599(): PHPStan\Type\Symfony\InputBagTypeSpecifyingExtension
	{
		return new PHPStan\Type\Symfony\InputBagTypeSpecifyingExtension;
	}


	public function createService0600(): PHPStan\Symfony\RequiredAutowiringExtension
	{
		return new PHPStan\Symfony\RequiredAutowiringExtension($this->getService('0170'));
	}


	public function createService0601(): PHPStan\Type\Symfony\CacheInterfaceGetDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Symfony\CacheInterfaceGetDynamicReturnTypeExtension;
	}


	public function createService0602(): PHPStan\Type\Symfony\ExtensionGetConfigurationReturnTypeExtension
	{
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/../../../tmp/phpstan/cache/PHPStan');
	}


	public function createServiceContainer(): Container_0eb69a9442
	{
		return $this;
	}
	...
	{
		return new PHPStan\Type\Doctrine\ArgumentsProcessor($this->getService('0483'));
	}


	public function createServiceDoctrineTypeDescriptorRegistry(): PHPStan\Type\Doctrine\DefaultDescriptorRegistry
	{
		return $this->getService('0474')->createRegistry();
	}
	...
	{
		return new PHPStan\File\ParentDirectoryRelativePathHelper('/data/www/salt-and-pepper.lan/dev/webroot');
	}
	...
	public function createServiceRules__164(): PHPStan\Rules\Constants\MissingClassConstantTypehintRule
	{
		return new PHPStan\Rules\Constants\MissingClassConstantTypehintRule($this->getService('0153'));
	}


	public function createServiceRules__165(): PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule($this->getService('0153'));
	}


	public function createServiceRules__166(): PHPStan\Rules\Methods\MissingMethodReturnTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodReturnTypehintRule($this->getService('0153'));
	}


	public function createServiceRules__167(): PHPStan\Rules\Properties\MissingPropertyTypehintRule
	{
		return new PHPStan\Rules\Properties\MissingPropertyTypehintRule($this->getService('0153'));
	}


	public function createServiceRules__168(): PHPStan\Rules\Doctrine\ORM\DqlRule
	{
		return new PHPStan\Rules\Doctrine\ORM\DqlRule($this->getService('0483'));
	}


	public function createServiceRules__169(): PHPStan\Rules\Doctrine\ORM\RepositoryMethodCallRule
	{
		return new PHPStan\Rules\Doctrine\ORM\RepositoryMethodCallRule($this->getService('0483'));
	}
	...
	public function createServiceRules__170(): PHPStan\Rules\Doctrine\ORM\EntityNotFinalRule
	{
		return new PHPStan\Rules\Doctrine\ORM\EntityNotFinalRule($this->getService('0483'));
	}


	public function createServiceRules__171(): PHPStan\Rules\Symfony\ContainerInterfacePrivateServiceRule
	{
		return new PHPStan\Rules\Symfony\ContainerInterfacePrivateServiceRule($this->getService('0555'));
	}


	public function createServiceRules__172(): PHPStan\Rules\Symfony\ContainerInterfaceUnknownServiceRule
	{
		return new PHPStan\Rules\Symfony\ContainerInterfaceUnknownServiceRule($this->getService('0555'), $this->getService('021'));
	}


	public function createServiceRules__173(): PHPStan\Rules\Symfony\UndefinedArgumentRule
	{
		return new PHPStan\Rules\Symfony\UndefinedArgumentRule($this->getService('0554'), $this->getService('021'));
	}


	public function createServiceRules__174(): PHPStan\Rules\Symfony\InvalidArgumentDefaultValueRule
	{
		return new PHPStan\Rules\Symfony\InvalidArgumentDefaultValueRule;
	}


	public function createServiceRules__175(): PHPStan\Rules\Symfony\UndefinedOptionRule
	{
		return new PHPStan\Rules\Symfony\UndefinedOptionRule($this->getService('0554'), $this->getService('021'));
	}


	public function createServiceRules__176(): PHPStan\Rules\Symfony\InvalidOptionDefaultValueRule
	{
	...
	{
		return new PHPStan\File\SimpleRelativePathHelper('/data/www/salt-and-pepper.lan/dev/webroot');
	}
	...
	{
		return new PHPStan\Symfony\XmlParameterMapFactory($this->getService('0553'));
	}


	public function createServiceSymfony__serviceMapFactory(): PHPStan\Symfony\ServiceMapFactory
	{
		return new PHPStan\Symfony\XmlServiceMapFactory($this->getService('0553'));
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'memoryLimitFile' => '/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/../../../tmp/phpstan/.memory_limit',
			'tempResultCachePath' => '/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/../../../tmp/phpstan/resultCaches',
			'resultCachePath' => '/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/../../../tmp/phpstan/resultCache.php',
			...
			'doctrine' => [
				...
				'objectManagerLoader' => '/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/../../../tests/phpstan/object_manager.php',
			...
			'tmpDir' => '/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/../../../tmp/phpstan',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan/../../../tmp/phpstan',
			'rootDir' => '/data/www/salt-and-pepper.lan/dev/webroot/vendor/phpstan/phpstan',
			'currentWorkingDirectory' => '/data/www/salt-and-pepper.lan/dev/webroot',
			...
			'composerAutoloaderProjectPaths' => ['/data/www/salt-and-pepper.lan/dev/webroot'],
